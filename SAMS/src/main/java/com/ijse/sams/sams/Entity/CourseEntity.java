...
public class CourseEntity {
    ...
    public CourseEntity(String courseId, String courseName, String courseDescription, String lecturer, String courseDuration, String courseFee, String courseStream, String courseMinQualification) {
    ...
    public CourseEntity(String courseStream) {
        this.courseStream = courseStream;
    }
